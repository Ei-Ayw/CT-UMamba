...
def parse_args():
    ...
    parser.add_argument("--img-dir", default="data/vaihingen/val_images")
    parser.add_argument("--mask-dir", default="data/vaihingen/val_masks")
    parser.add_argument("--output-img-dir", default="data/vaihingen/val_1024/images")
    parser.add_argument("--output-mask-dir", default="data/vaihingen/val_1024/masks_rgb")
