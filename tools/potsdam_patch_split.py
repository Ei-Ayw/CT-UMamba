...
def parse_args():
    ...
    parser.add_argument("--img-dir", default="data/potsdam/test_images")
    parser.add_argument("--mask-dir", default="data/potsdam/test_masks_eroded")
    parser.add_argument("--output-img-dir", default="data/potsdam/test_1024/images")
    parser.add_argument("--output-mask-dir", default="data/potsdam/test_1024/masks")
