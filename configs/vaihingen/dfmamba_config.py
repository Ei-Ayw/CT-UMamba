...
from dfmamba.datasets.vaihingen_dataset import *
import sys
...
weights_path = "/root/lanyun-fs/DFMamba/model_weights/vaihingen/{}".format(weights_name)
...
pretrained_ckpt_path = "root/lanyun-fs/DFMamba/pretrain_weights/rest_lite.pth"# the path for the pretrained DFMamba weight
