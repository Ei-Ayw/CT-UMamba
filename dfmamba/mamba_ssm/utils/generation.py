...
class InferenceParams:
    """Inference parameters that are passed to the main DFMamba in order
...
def update_graph_cache(
    ...
    if (
        ...
        assert hasattr(model, "allocate_inference_cache"), "CUDA graph decoding requires that the DFMamba has a method allocate_inference_cache"
