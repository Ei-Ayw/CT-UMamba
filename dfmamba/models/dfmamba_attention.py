"""
消融实验版本：Unet+Rest+ConvNext+Attention
保留：Attention (CoordAtt)
移除：Fuser (DF_Module) 和对比学习Loss
...
class TCMDFMConvNeXtMamba(nn.Module):
    ...
    def __init__(self,
        ...
        self.contrast_enable = False  # 强制禁用对比学习
...
if __name__ == "__main__":
    ...
    print("消融实验：Unet+Rest+ConvNext+Attention 创建成功!")
